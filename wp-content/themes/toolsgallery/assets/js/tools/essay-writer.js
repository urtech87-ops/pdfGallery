(function () {
  ...
  /* Topic */
  var lbl1 = document.createElement('label'); lbl1.className = 'tg-ai5-label'; lbl1.textContent = 'Essay Topic';
  var topicInput = document.createElement('input');
  topicInput.className = 'tg-ai5-input'; topicInput.type = 'text';
  topicInput.placeholder = 'Enter your essay topic...'; topicInput.required = true;
  var w1 = document.createElement('div'); w1.appendChild(lbl1); w1.appendChild(topicInput);
  form.appendChild(w1);

  /* Essay type */
  var lbl2 = document.createElement('label'); lbl2.className = 'tg-ai5-label'; lbl2.textContent = 'Essay Type';
  var typeSel = makeSelect(['Argumentative', 'Descriptive', 'Expository', 'Narrative', 'Persuasive', 'Compare & Contrast'], 'Argumentative');
  ...
  var wordGroup = makeSingleToggleGroup(['250', '500', '750', '1000', '1500', '2000'], '500');
  var w3 = document.createElement('div'); w3.appendChild(lbl3); w3.appendChild(wordGroup);
  form.appendChild(w3);

  /* Academic level */
  var lbl4 = document.createElement('label'); lbl4.className = 'tg-ai5-label'; lbl4.textContent = 'Academic Level';
  var levelGroup = makeSingleToggleGroup(['High School', 'Undergraduate', 'Graduate', 'Professional'], 'Undergraduate');
  var w4 = document.createElement('div'); w4.appendChild(lbl4); w4.appendChild(levelGroup);
  form.appendChild(w4);

  /* Structure */
  var lbl5 = document.createElement('label'); lbl5.className = 'tg-ai5-label'; lbl5.textContent = 'Include Structure';
  var structureGroup = makeMultiToggleGroup(
    ['Introduction', 'Body paragraphs', 'Conclusion', 'Citations placeholder', 'Thesis highlight'],
    ['Introduction', 'Body paragraphs', 'Conclusion', 'Citations placeholder', 'Thesis highlight']
  );
  var w5 = document.createElement('div'); w5.appendChild(lbl5); w5.appendChild(structureGroup);
  form.appendChild(w5);

  /* Tone */
  var lbl6 = document.createElement('label'); lbl6.className = 'tg-ai5-label'; lbl6.textContent = 'Tone';
  var toneGroup = makeSingleToggleGroup(['Formal', 'Semi-formal', 'Academic'], 'Formal');
  var w6 = document.createElement('div'); w6.appendChild(lbl6); w6.appendChild(toneGroup);
  form.appendChild(w6);

  /* Submit */
  var submitBtn = document.createElement('button');
  submitBtn.type = 'button'; submitBtn.className = 'tg-ai5-btn';
  submitBtn.textContent = 'Write Essay'; submitBtn.disabled = true;
  ...
  loading.innerHTML = '<span class="tg-ai5-dot"></span><span class="tg-ai5-dot"></span><span class="tg-ai5-dot"></span><span>Writing essay…</span>';
  ...
  submitBtn.addEventListener('click', function () {
    ...
    var structVals = structureGroup.getValues();
    var payload = {
      topic: topic,
      type: typeSel.value,
      length: wordGroup.getValue(),
      level: levelGroup.getValue(),
      structure: structVals.length ? structVals.join(', ') : 'none',
