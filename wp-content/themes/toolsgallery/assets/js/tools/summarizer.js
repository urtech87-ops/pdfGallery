(function () {
  ...
  lbl1.textContent = 'Text to Summarize';
  ...
  lbl2.textContent = 'Summary Type';
  var typeGroup = makeToggleGroup(['Brief', 'Standard', 'Detailed', 'Bullet Points', 'Executive Summary'], 'Standard');
  var w2 = document.createElement('div'); w2.appendChild(lbl2); w2.appendChild(typeGroup);
  form.appendChild(w2);

  /* Focus select */
  var lbl3 = document.createElement('label');
  lbl3.className = 'tg-ai5-label';
  lbl3.textContent = 'Focus';
  var focusSel = makeSelect(['Key Points', 'Main Arguments', 'Facts & Data', 'Action Items', 'All'], 'Key Points');
  var w3 = document.createElement('div'); w3.appendChild(lbl3); w3.appendChild(focusSel);
  form.appendChild(w3);

  /* Language select */
  var lbl4 = document.createElement('label');
  lbl4.className = 'tg-ai5-label';
  lbl4.textContent = 'Output Language';
  var langSel = makeSelect(['Same as input', 'English', 'Arabic', 'Spanish', 'French', 'German', 'Chinese', 'Japanese', 'Portuguese', 'Russian', 'Hindi'], 'Same as input');
  var w4 = document.createElement('div'); w4.appendChild(lbl4); w4.appendChild(langSel);
  form.appendChild(w4);
  ...
  loading.innerHTML = '<span class="tg-ai5-dot"></span><span class="tg-ai5-dot"></span><span class="tg-ai5-dot"></span><span>Summarizing…</span>';
  ...
  submitBtn.addEventListener('click', function () {
    ...
    var langVal = langSel.value;
    var payload = {
      text: text,
      type: typeGroup.getValue(),
      focus: focusSel.value,
      language: langVal === 'Same as input' ? 'the same language as the input text' : langVal
    };
