(function () {
  ...
  function makeToggleGroup(options, defaultVal, multiSelect) {
  ...
  lbl1.textContent = 'Text to Paraphrase';
  var textarea = document.createElement('textarea');
  textarea.className = 'tg-ai5-textarea';
  textarea.placeholder = 'Enter text to paraphrase...';
  var wrap1 = document.createElement('div');
  wrap1.appendChild(lbl1); wrap1.appendChild(textarea);
  form.appendChild(wrap1);

  /* Mode */
  var lbl2 = document.createElement('label');
  lbl2.className = 'tg-ai5-label';
  lbl2.textContent = 'Mode';
  var modeGroup = makeToggleGroup(['Standard', 'Fluent', 'Creative', 'Formal', 'Simple'], 'Standard');
  var wrap2 = document.createElement('div');
  wrap2.appendChild(lbl2); wrap2.appendChild(modeGroup);
  form.appendChild(wrap2);

  /* Count */
  var lbl3 = document.createElement('label');
  lbl3.className = 'tg-ai5-label';
  lbl3.textContent = 'Number of Variations';
  var countGroup = makeToggleGroup(['1', '2', '3'], '1');
  var wrap3 = document.createElement('div');
  wrap3.appendChild(lbl3); wrap3.appendChild(countGroup);
  form.appendChild(wrap3);

  /* Length */
  var lbl4 = document.createElement('label');
  lbl4.className = 'tg-ai5-label';
  lbl4.textContent = 'Word Limit';
  var lengthGroup = makeToggleGroup(['Same length', 'Shorter', 'Longer'], 'Same length');
  var wrap4 = document.createElement('div');
  wrap4.appendChild(lbl4); wrap4.appendChild(lengthGroup);
  form.appendChild(wrap4);

  /* Submit */
  var submitBtn = document.createElement('button');
  submitBtn.type = 'button';
  submitBtn.className = 'tg-ai5-btn';
  submitBtn.textContent = 'Paraphrase';
  ...
  loading.innerHTML = '<span class="tg-ai5-dot"></span><span class="tg-ai5-dot"></span><span class="tg-ai5-dot"></span><span>Paraphrasing…</span>';
  ...
  var lengthMap = {
    'Same length': 'the same length as original',
    'Shorter': 'shorter than original',
    'Longer': 'longer than original'
  };
  ...
  submitBtn.addEventListener('click', function () {
    ...
    var lengthVal = lengthGroup.getValue();
    var payload = {
      text: text,
      mode: modeGroup.getValue().toLowerCase(),
      count: countGroup.getValue(),
      length: lengthMap[lengthVal] || 'the same length as original'
    };
